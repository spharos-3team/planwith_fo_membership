package com.planwith.planwith_fo_membership.controller;
...
import com.planwith.planwith_fo_membership.dto.LoginRequest;
import com.planwith.planwith_fo_membership.dto.LoginResponse;
import com.planwith.planwith_fo_membership.service.AuthService;
...
@Tag(name = "planwith-fo-membership", description = "Server notebook deploy verification API")
public class DeployController {
	...
	public ResponseEntity<Map<String, String>> deployCheck() {
		return ResponseEntity.ok(Map.of(
				"service", "planwith-fo-membership",
				"marker", deployProperties.marker(),
				"message", "planwith-fo-membership deploy pipeline ok"
		));
	}
